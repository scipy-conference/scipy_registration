...
$sql_registrants .= "participants.client_id, ";
...
$sql_registrants .= "participant_type_id, ";
$sql_registrants .= "tshirt_type_id, ";
$sql_registrants .= "tshirt_size_id, ";
...
$sql_registrants .= "registrations.created_at ";
...
$participant_type_id = $row['participant_type_id'];
$tshirt_type_id = $row['tshirt_type_id'];
$tshirt_size_id = $row['tshirt_size_id'];
...
$reg_session[$row['session_id']] = $row['session'];
  }
...
$display_sessions .=    "
  ...
  //    if ($row['session'] == "Conference")
      if (array_search ( $row['session'], $reg_session ))
        {
...
$display_participants .=    "
  <tr>
    ...
    if ($participant_type_id == $row[id])
      {
        $display_participants .="checked";
      }
...
<input type="hidden" name="participant_id" value="<?php echo $_GET['id'] ?>" />
<div align="center">
